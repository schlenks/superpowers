...
5. For artifacts >50 lines: Apply superpowers:rule-of-five passes (Draft, Correctness, Clarity, Edge Cases, Excellence)
6. Commit the work
...
- **Apply superpowers:rule-of-five to artifacts >50 lines**
